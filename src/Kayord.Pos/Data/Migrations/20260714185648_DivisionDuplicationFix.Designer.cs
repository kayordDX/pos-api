...
namespace Kayord.Pos.Data.Migrations
{
    ...
    [Migration("20260714185648_DivisionDuplicationFix")]
    partial class DivisionDuplicationFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.BillCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bill_category");

                    b.ToTable("bill_category", (string)null);
                });
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.Division", b =>
                {
                    ...
                    b.HasIndex("DivisionName", "OutletId")
                        .IsUnique()
                        .HasDatabaseName("ix_division_division_name_outlet_id")
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.MenuItem", b =>
                {
                    ...
                    b.Property<int?>("BillCategoryId")
                        .HasColumnType("integer")
                        .HasColumnName("bill_category_id");
                    ...
                    b.HasIndex("BillCategoryId")
                        .HasDatabaseName("ix_menu_item_bill_category_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.OutletFeature", b =>
                {
                    ...
                    b.HasKey("FeatureId", "OutletId")
                        .HasName("pk_outlet_feature");

                    b.HasIndex("OutletId")
                        .HasDatabaseName("ix_outlet_feature_outlet_id");

                    b.ToTable("outlet_feature", (string)null);
                });
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.RoleDivision", b =>
                {
                    ...
                    b.HasIndex("RoleId", "DivisionId")
                        .IsUnique()
                        .HasDatabaseName("ix_role_division_role_id_division_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.MenuItem", b =>
                {
                    b.HasOne("Kayord.Pos.Entities.BillCategory", "BillCategory")
                        .WithMany()
                        .HasForeignKey("BillCategoryId")
                        .HasConstraintName("fk_menu_item_bill_category_bill_category_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.OutletFeature", b =>
                {
                    b.HasOne("Kayord.Pos.Entities.Feature", "Feature")
                        .WithMany()
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outlet_feature_feature_feature_id");
                    ...
                    b.HasOne("Kayord.Pos.Entities.Outlet", "Outlet")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outlet_feature_outlet_outlet_id");
