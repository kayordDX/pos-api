...
namespace Kayord.Pos.Data.Migrations
{
    ...
    [Migration("20240618195746_CashuptypesNullIdAndPayId")]
    partial class CashuptypesNullIdAndPayId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.CashupUserItem", b =>
                {
                    ...
                    b.Property<int>("CashupItemTypeId")
                        .HasColumnType("integer");

                    b.Property<int>("CashupItemTypesId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CashupItemTypesId");

                    b.HasIndex("UserCashupId");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.CashupUserItem", b =>
                {
                    b.HasOne("Kayord.Pos.Entities.CashupUserItemType", "CashupItemTypes")
                        .WithMany()
                        .HasForeignKey("CashupItemTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kayord.Pos.Entities.CashupUser", "UserCashup")
                        .WithMany("CashupUserItems")
                        .HasForeignKey("UserCashupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CashupItemTypes");

                    b.Navigation("UserCashup");
                });
