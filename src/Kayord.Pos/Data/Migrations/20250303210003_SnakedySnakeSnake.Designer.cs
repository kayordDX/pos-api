...
namespace Kayord.Pos.Data.Migrations
{
    ...
    [Migration("20250303210003_SnakedySnakeSnake")]
    partial class SnakedySnakeSnake
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.ExtraStock", b =>
                {
                    ...
                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_extra_stock_unit_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.OptionStock", b =>
                {
                    ...
                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_option_stock_unit_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.StockAllocate", b =>
                {
                    ...
                    b.Property<string>("AssignedUserUserId")
                        .HasColumnType("text")
                        .HasColumnName("assigned_user_user_id");
                    ...
                    b.Property<string>("FromUserUserId")
                        .HasColumnType("text")
                        .HasColumnName("from_user_user_id");
                    ...
                    b.HasIndex("AssignedUserUserId")
                        .HasDatabaseName("ix_stock_allocate_assigned_user_user_id");

                    b.HasIndex("FromDivisionId")
                        .HasDatabaseName("ix_stock_allocate_from_division_id");

                    b.HasIndex("FromUserUserId")
                        .HasDatabaseName("ix_stock_allocate_from_user_user_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.StockAllocateItem", b =>
                {
                    ...
                    b.HasIndex("DivisionId")
                        .HasDatabaseName("ix_stock_allocate_item_division_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.StockItem", b =>
                {
                    ...
                    b.HasIndex("StockId")
                        .HasDatabaseName("ix_stock_item_stock_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.ExtraStock", b =>
                {
                    ...
                    b.HasOne("Kayord.Pos.Entities.Unit", "Unit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_extra_stock_unit_unit_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.OptionStock", b =>
                {
                    ...
                    b.HasOne("Kayord.Pos.Entities.Unit", "Unit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_option_stock_unit_unit_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.StockAllocate", b =>
                {
                    b.HasOne("Kayord.Pos.Entities.User", "AssignedUser")
                        ...
                        .HasConstraintName("fk_stock_allocate_user_assigned_user_user_id");
                    ...
                    b.HasOne("Kayord.Pos.Entities.User", "FromUser")
                        ...
                        .HasConstraintName("fk_stock_allocate_user_from_user_user_id");
            ...
            modelBuilder.Entity("Kayord.Pos.Entities.StockAllocateItem", b =>
                {
                    b.HasOne("Kayord.Pos.Entities.Division", "Division")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_stock_allocate_item_division_division_id");
