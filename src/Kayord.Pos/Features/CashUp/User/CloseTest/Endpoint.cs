...
namespace Kayord.Pos.Features.CashUp.User.CloseTest;

public class Endpoint : Endpoint<Close.Request, CashUpUserItem>
{
    ...
    public override async Task HandleAsync(Close.Request req, CancellationToken ct)
    {
